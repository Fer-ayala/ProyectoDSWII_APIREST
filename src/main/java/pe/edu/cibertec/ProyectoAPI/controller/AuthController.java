...
import pe.edu.cibertec.ProyectoAPI.model.dto.UsuarioSeguridadDto;
import pe.edu.cibertec.ProyectoAPI.service.DetalleEmpleadoService;
...
public class AuthController {
    ...
    public ResponseEntity<UsuarioSeguridadDto> autenticarUsuario(
        ...
        try{
            ...
            if(authentication.isAuthenticated()){
                Usuario objUsuario = detalleEmpleadoService
    ...
    private String generarToken(Usuario usuario){
        Empleado objEmpleado = detalleEmpleadoService.obtenerEmpleadoxNomusuario(usuario.getNombres());
        String clave = "@Cibertec2024";
        List<GrantedAuthority> grantedAuthorityList =
                detalleEmpleadoService.obtenerListaRoles(objEmpleado.getRol());
